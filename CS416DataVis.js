            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.oil_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.cement_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.coal_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.consumption_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.flaring_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.gas_co2)))+"px"
            ...
            .append("circle")
                ...
                .on("mouseover",function(d) {
                    ...
                    d3.select("#scene2svg")
                        ...
                        tooltip2y.style.left = eval((width*.35)+((scaleX(d.year)-5) - (marginx-5))/2)+"px"
                        tooltip2y.style.top = eval((height * .4+55) - ((height * .4 + 5) - scaleY(d.trade_co2)))+"px"
